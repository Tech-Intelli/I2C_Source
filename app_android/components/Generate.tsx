...
export default function Generate({ route, navigation }: GenerateProps) {
  ...
  const handlePress = async()=>{
    ...
    await axios.get(`http://192.168.178.54:9000/generate_image_video_caption?caption_size=${selectedSize}&context=${memory}&style=${selectedStyle}&num_hashtags=${hashtags}&tone=${tone}&social_media=${socials}&file_name=${JSON.stringify(filename)}&address=${address}`,{
      headers:{
